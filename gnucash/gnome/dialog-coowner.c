...
void gnc_coowner_addr2_insert_cb(
    GtkEditable *editable,
    gchar *new_text, gint new_text_length,
    gint *position, gpointer user_data);
void gnc_coowner_addr3_insert_cb(
    GtkEditable *editable,
    gchar *new_text, gint new_text_length,
    gint *position, gpointer user_data);
void gnc_coowner_addr4_insert_cb(
    GtkEditable *editable,
    gchar *new_text, gint new_text_length,
    gint *position, gpointer user_data);

gboolean gnc_coowner_addr2_key_press_cb(
    GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_addr3_key_press_cb(
    GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean nc_coowner_addr4_key_press_cb(
    GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_addr2_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_addr3_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_addr4_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
...
gboolean gnc_coowner_shipaddr2_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_shipaddr3_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );
gboolean gnc_coowner_shipaddr4_key_press_cb( GtkEntry *entry, GdkEventKey *event,
    gpointer user_data );

#define ADDR_QUICKFILL "GncAddress-Quickfill"

void gnc_coowner_apt_share_changed_cb (GtkWidget *widget, gpointer data);
void gnc_coowner_apt_unit_changed_cb (GtkWidget *widget, gpointer data);
void gnc_coowner_ccard_acct_toggled_cb (GtkToggleButton *button, gpointer data);
void gnc_coowner_distribution_key_changed_cb (GtkWidget *widget, gpointer data);
void gnc_coowner_language_changed_cb (GtkWidget *widget, gpointer data);
...
struct _coowner_window
{
    ...
    GtkWidget *coowner_entry_addrname;
    GtkWidget *coowner_entry_addr1;
    GtkWidget *coowner_entry_addr2;
    GtkWidget *coowner_entry_addr3;
    GtkWidget *coowner_entry_addr4;
    GtkWidget *coowner_entry_phone;
    GtkWidget *coowner_entry_fax;
    GtkWidget *coowner_entry_email;
...
static void gnc_ui_to_coowner (CoOwnerWindow *ow, GncCoOwner *coowner)
{
    ...
    /* Parse and set the username (e.g. the tenant) */
...
static gboolean check_edit_amount (
    GtkWidget *amount,
...
{
    CoOwnerWindow *ow = data;
    gnc_numeric min, max, share_min, share_max;
    gchar *string;
    ...
    if (g_strcmp0 (gtk_entry_get_text (GTK_ENTRY (ow->coowner_entry_coowner_id)), "") == 0)
    {
    ...
    if (check_entry_nonempty (ow->coowner_entry_coowner_name,
    ...
    if (check_entry_nonempty (ow->coowner_entry_addrname,
    ...
    /* if (check_edit_amount (ow->coowner_entry_apt_share, &share_min, &share_max, */
    /*                        _("Apartment share value must be set " */
    /*                          "inside the valid range [0-1000]."))) */
    /*     return; */

    /* Verify that apartment unit name is valid */
    /* if (check_entry_nonempty (ow->coowner_entry_apt_unit, */
    /*                           _("The name referencing the Apartment Unit cannot be left blank, please " */
    /*                             "enter a valid identification string."))) */
    /*       return; */

    /* Verify that distribution key is valid */
    if (check_entry_nonempty (ow->coowner_entry_distribution_key,
    ...
    currency = gnc_currency_edit_get_currency (GNC_CURRENCY_EDIT(ow->coowner_entry_currency));
    print_info = gnc_commodity_print_info (currency, FALSE);

    /* Verify that credit amount is valid (or empty) */
    min = gnc_numeric_zero ();
    gnc_amount_edit_set_print_info (GNC_AMOUNT_EDIT (ow->coowner_entry_credit), print_info);
    gnc_amount_edit_set_fraction (GNC_AMOUNT_EDIT (ow->coowner_entry_credit),
        gnc_commodity_get_fraction (currency));
    if (check_edit_amount (ow->coowner_entry_credit, &min, NULL,
    ...
    if (check_edit_amount (ow->coowner_entry_discount, &min, &max,
                         ...
                         GncCoOwner *coowner)
{
    ...
    gnc_builder_add_from_file (builder, "dialog-coowner.glade", "coowner_liststore_taxincluded");
    gnc_builder_add_from_file (builder, "dialog-coowner.glade", "coowner_liststore_taxtable");
    gnc_builder_add_from_file (builder, "dialog-coowner.glade", "coowner_liststore_terms");
    ...
    ow->coowner_entry_coowner_id = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_coowner_id"));
    ow->coowner_entry_coowner_name = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_coowner_name"));


    ow->coowner_checkbutton_active = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_checkbutton_active"));

    /* Address fields */
    ow->coowner_entry_addrname = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_addrname"));
    ow->coowner_entry_addr1 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_addr1"));
    ow->coowner_entry_addr2 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_addr2"));
    ow->coowner_entry_addr3 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_addr3"));
    ow->coowner_entry_addr4 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_addr4"));
    ow->coowner_entry_phone = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_phone"));
    ow->coowner_entry_fax = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_fax"));
    ow->coowner_entry_email = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_email"));
    ...
    print_info.max_decimal_places = 6;
    gnc_amount_edit_set_print_info (GNC_AMOUNT_EDIT (edit), print_info);
    gnc_amount_edit_set_fraction (GNC_AMOUNT_EDIT (edit), 1000000);
    ow->coowner_entry_discount = edit;
    gtk_widget_show (edit);

    hbox = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_box_apt_share"));
    gtk_box_pack_start (GTK_BOX (hbox), edit, TRUE, TRUE, 0);

    /* Apartment unit value */
    ow->coowner_entry_apt_unit = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_apt_unit"));

    /* Distribution key value */
    ow->coowner_entry_distribution_key = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_distribution_key"));

    /* Language */
    ow->coowner_entry_language = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_language"));

    /* Notes */
    ow->coowner_entry_text = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_entry_text"));

    /* Username: maybe rename to Tenant  */
    ...
    hbox = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_box_credit"));
    gtk_box_pack_start (GTK_BOX (hbox), edit, TRUE, TRUE, 0);
    ...
    hbox = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_box_currency"));
    gtk_box_pack_start (GTK_BOX (hbox), edit, TRUE, TRUE, 0);
    ...
    hbox = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_box_discount"));
    gtk_box_pack_start (GTK_BOX (hbox), edit, TRUE, TRUE, 0);

    /* Tax table */
    ow->coowner_combobox_taxincluded = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_combobox_taxincluded"));
    ow->coowner_button_taxtable = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_button_taxtable"));
    ow->coowner_combobox_taxtable = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_combobox_taxtable"));

    /* Terms  */
    ow->coowner_combobox_terms = GTK_WIDGET (gtk_builder_get_object (builder, "coowner_combobox_terms"));
    ...
    /* Shiping fields */
    ow->coowner_entry_shipname = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipname"));
    ow->coowner_entry_shipaddr1 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipaddr1"));
    ow->coowner_entry_shipaddr2 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipaddr2"));
    ow->coowner_entry_shipaddr3 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipaddr3"));
    ow->coowner_entry_shipaddr4 = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipaddr4"));
    ow->coowner_entry_shipphone = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipphone"));
    ow->coowner_entry_shipfax = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipfax"));
    ow->coowner_entry_shipemail = GTK_WIDGET(gtk_builder_get_object (builder, "coowner_entry_shipemail"));
    ...
    if (coowner != NULL)
    {
        ...
        /* Setup Address */
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_addrname),
            gncAddressGetName (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_addr1),
            gncAddressGetAddr1 (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_addr2),
            gncAddressGetAddr2 (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_addr3),
            gncAddressGetAddr3 (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_addr4),
            gncAddressGetAddr4 (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_phone),
            gncAddressGetPhone (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_fax),
            gncAddressGetFax (addr));
        gtk_entry_set_text (GTK_ENTRY (ow->coowner_entry_email),
    ...
    ow->addr2_quickfill = gnc_get_shared_address_addr2_quickfill(ow->book,
        ADDR_QUICKFILL);
    ow->addr3_quickfill = gnc_get_shared_address_addr3_quickfill(ow->book,
        ADDR_QUICKFILL);
    ow->addr4_quickfill = gnc_get_shared_address_addr4_quickfill(ow->book,
        ADDR_QUICKFILL);
...
gnc_coowner_search (GtkWindow *parent, GncCoOwner *start, QofBook *book)
{
    ...
    if (params == NULL)
    {
        params = gnc_search_param_prepend (params, _("Co-Owner ID"), NULL,
                                           type, COOWNER_ID, NULL);
        params = gnc_search_param_prepend (params, _("Co-Owner Name"), NULL,
                                           type, COOWNER_NAME, NULL);
        params = gnc_search_param_prepend (params, _("Apartment Unit"), NULL,
                                           type, COOWNER_APT_UNIT, NULL);
        params = gnc_search_param_prepend (params, _("Settlement Contact"),
                                           NULL,
                                           type, COOWNER_ADDR,
                                           ADDRESS_NAME, NULL);
        params = gnc_search_param_prepend (params, _("Shipping Contact"), NULL,
                                           type, COOWNER_SHIPADDR,
                                           ADDRESS_NAME, NULL);
        params = gnc_search_param_prepend (params, _("Co-Owner Username"),
                                           NULL,
    ...
    if (columns == NULL)
    {
        columns = gnc_search_param_prepend (columns, _("Username"), NULL,
                                            type,
                                            COOWNER_USERNAME, NULL);
        params = gnc_search_param_prepend (columns, _("Shipping Contact"),
                                           NULL, type,
                                           COOWNER_SHIPADDR, ADDRESS_NAME,
                                           NULL);
        columns = gnc_search_param_prepend (columns, _("Settlement Contact"),
                                            NULL,
                                            type, COOWNER_ADDR, ADDRESS_NAME,
                                            NULL);
        columns = gnc_search_param_prepend (columns, _("Apartment Unit"),
                                            NULL, type,
...
idle_select_region_addr2(gpointer user_data)
{
    ...
    gtk_editable_select_region(GTK_EDITABLE(wdata->coowner_entry_addr2),
...
idle_select_region_addr3(gpointer user_data)
{
    ...
    gtk_editable_select_region(GTK_EDITABLE(wdata->coowner_entry_addr3),
                               wdata->addrX_start_selection,
                               wdata->addrX_end_selection);
...
idle_select_region_addr4(gpointer user_data)
{
    ...
    gtk_editable_select_region(GTK_EDITABLE(wdata->coowner_entry_addr4),
                               wdata->addrX_start_selection,
                               wdata->addrX_end_selection);
    wdata->addrX_selection_source_id = 0;
    return FALSE;
...
static gboolean
gnc_coowner_common_key_press_cb( GtkEntry *entry,
                                 GdkEventKey *event,
...
gboolean
gnc_coowner_addr2_key_press_cb( GtkEntry *entry,
                                GdkEventKey *event,
                                gpointer user_data )
{
    CoOwnerWindow *wdata = user_data;
    return gnc_coowner_common_key_press_cb(entry, event, user_data,
         wdata->coowner_entry_addr2);
}

gboolean
gnc_coowner_addr3_key_press_cb( GtkEntry *entry,
                                GdkEventKey *event,
                                gpointer user_data )
{
    CoOwnerWindow *wdata = user_data;
    return gnc_coowner_common_key_press_cb(entry, event, user_data,
        wdata->coowner_entry_addr3);
}

gboolean
gnc_coowner_addr4_key_press_cb( GtkEntry *entry,
                                GdkEventKey *event,
                                gpointer user_data )
{
    CoOwnerWindow *wdata = user_data;
    return gnc_coowner_common_key_press_cb(entry, event, user_data,
        wdata->coowner_entry_addr4);
}
