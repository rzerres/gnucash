...
>>>>>>> 5627a06966 ([bindings/python] update scripts to handle Co-Owner)
...
class Session(GnuCashCoreClass):
    ...
    be interested in, as every GnuCash entity (Transaction, Split, Employee,
    Coowner, Customer, Invoice, Job, ...) is associated with a particulari
    book where it is stored.
    """
...
class Book(GnuCashCoreClass):
    ...
    def CoOwnerLookup(self, guid):
        ...
        return self.do_lookup_create_oo_instance(
            gncCoOwnerLookup, CoOwner, guid.get_instance())
