...
coowner_dom_tree_create (GncCoOwner* coowner)
{
    ...
    xmlAddChild (ret, commodity_ref_to_dom_tree (coowner_currency_string,
    ...
    xmlAddChild (ret, text_to_dom_tree (coowner_language_string,
        gncCoOwnerGetLanguage (coowner)));

    xmlAddChild (ret, text_to_dom_tree (coowner_name_string,
...
static gboolean
coowner_language_handler (xmlNodePtr node, gpointer coowner_pdata)
{
    struct coowner_pdata *pdata = static_cast<decltype (pdata)> (coowner_pdata);
...
static gboolean
coowner_name_handler (xmlNodePtr node, gpointer coowner_pdata)
{
    struct coowner_pdata *pdata = static_cast<decltype (pdata)> (coowner_pdata);
...
coowner_ship_addr_handler (xmlNodePtr node, gpointer coowner_pdata)
{
    ...
    return gnc_dom_tree_to_address (node, gncCoOwnerGetShipAddr (pdata->coowner));
}
...
{
    struct coowner_pdata *pdata = static_cast<decltype (pdata)> (coowner_pdata);
    auto set_tax_included = [](GncCoOwner* coowner, const char *str)
    {
    GncTaxIncluded type;
...
static struct dom_tree_handler coowner_handlers_v2[] =
{
    ...
    { coowner_discount_string, coowner_discount_handler, 1, 0 },
    { coowner_distribution_key_string, coowner_distribution_key_handler, 1, 0 },
